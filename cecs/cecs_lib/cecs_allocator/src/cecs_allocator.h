...
inline const cecs_bump_allocator *cecs_allocator_bump(const cecs_allocator *allocator) {
    cecs_debugbreak_fail_unless(allocator->type == cecs_internal_allocator_type_bump, "fatal error: tried to access wrong variant (bump) of allocator");
...
inline const cecs_arena_allocator *cecs_allocator_arena(const cecs_allocator *allocator) {
    cecs_debugbreak_fail_unless(allocator->type == cecs_internal_allocator_type_arena, "fatal error: tried to access wrong variant (arena) of allocator");
...
inline const cecs_implicit_arena_allocator *cecs_allocator_implicit_arena(const cecs_allocator *allocator) {
    cecs_debugbreak_fail_unless(allocator->type == cecs_internal_allocator_type_implicit_arena, "fatal error: tried to access wrong variant (implicit arena) of allocator");
