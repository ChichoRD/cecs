...
bool cecs_view_contains(const cecs_view view, const cecs_world_components *components, const cecs_entity_storage *entities, const cecs_entity entity) {
    cecs_view_expect_valid_or_exit(view);
...
void *cecs_view_mut_get_or_insert(
    ...
    cecs_view_mut_expect_valid_or_exit(view);
    return cecs_view_unchecked_get_or_insert(view.view, allocator, components, entities, entity);
}
void *cecs_view_mut_insert_expect(
    const cecs_view_mut view, cecs_allocator *allocator, cecs_world_components *components, const cecs_entity_storage *entities, const cecs_entity entity
) {
    cecs_view_mut_expect_valid_or_exit(view);
    return cecs_view_unchecked_insert_expect(view.view, allocator, components, entities, entity);
}
...
bool cecs_view_mut_remove(
    ...
    cecs_view_mut_expect_valid_or_exit(view);
    return cecs_view_unchecked_remove(view.view, allocator, components, entities, entity);
}
void cecs_view_mut_remove_expect(
    const cecs_view_mut view, cecs_allocator *allocator, cecs_world_components *components, const cecs_entity_storage *entities, const cecs_entity entity
) {
    cecs_view_mut_expect_valid_or_exit(view);
    cecs_view_unchecked_remove_expect(view.view, allocator, components, entities, entity);
}
