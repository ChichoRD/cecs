...
extern inline void cecs_exit_success(void);
extern inline void cecs_exit_failure(void);
extern inline void cecs_fail(void);

extern inline void cecs_assert_and_fail(const char *const message);
