...
inline cecs_dense_index cecs_dense_index_create_valid(const cecs_sparse_set_usize index) {
    ...
    return cecs_dense_index_create_unchecked(index);
}
inline cecs_dense_index cecs_dense_index_create_invalid(void) {
...
inline const cecs_dense_index *cecs_sparse_set_index_get(const cecs_sparse_set *set, const size_t key) {
...
inline cecs_dense_index *cecs_sparse_set_index_get_mut(cecs_sparse_set *set, const size_t key) {
    if (key >= cecs_sparse_set_sparse_range_size(set)) {
