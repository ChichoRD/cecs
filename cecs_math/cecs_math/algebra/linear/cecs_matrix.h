...
extern const cecs_mat4c_f32 cecs_mat4c_f32_identity;
extern const cecs_mat4c_f32 cecs_mat4c_f32_zero;

cecs_mat4c_f32 cecs_mat4c_f32_into_columns(const float raw[16]);

inline cecs_mat4c_f32 cecs_mat4c_f32_mul(const cecs_mat4c_f32 a, const cecs_mat4c_f32 b) {
...
inline cecs_vec4_f32 cecs_mat4c_f32_mul_vec4(const cecs_mat4c_f32 m, const cecs_vec4_f32 v) {
...
inline cecs_vec3_f32 cecs_mat4c_f32_mul_vec3(const cecs_mat4c_f32 m, const cecs_vec3_f32 v) {
...
inline cecs_vec3_f32 cecs_mat4c_f32_mul_vec3_ptr(const cecs_mat4c_f32 *m, const cecs_vec3_f32 v) {
    return (cecs_vec3_f32){
        .x = m->e0.x * v.x + m->e1.x * v.y + m->e2.x * v.z,
        .y = m->e0.y * v.x + m->e1.y * v.y + m->e2.y * v.z,
        .z = m->e0.z * v.x + m->e1.z * v.y + m->e2.z * v.z
...
inline cecs_mat4c_f32 cecs_mat4c_f32_scale(const cecs_mat4c_f32 m, const float s) {
    return (cecs_mat4c_f32){
...
inline float cecs_mat4c_f32_trace(const cecs_mat4c_f32 m) {
    return m.e0.x + m.e1.y + m.e2.z + m.e3.w;
}

inline cecs_mat4c_f32 cecs_mat4c_f32_transpose(const cecs_mat4c_f32 m) {
    return (cecs_mat4c_f32){
